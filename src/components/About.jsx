...
function About() {
  ...
  const { ref: timelineRef, controls: timelineControls } =
    useAnimateOnScroll(0.15);
  ...
  const highlights = [
    ...
    { text: "Azure Expert", icon: "☁️" },
    { text: "ETL Specialist", icon: "📊" },
  ...
  // Statistics display
  const stats = [
    { number: "50+", label: "Data Pipelines Built", icon: "🔄" },
    { number: "1B+", label: "Records Processed", icon: "📊" },
  ...
  const timeline = [
    ...
    },
    {
      ...
      title: "Data Analyst",
      description:
        "Transitioned to data analysis using Python, SQL, and visualization tools",
      icon: "📊",
    },
    {
      year: "2025",
      ...
      description:
        "Specialized in Azure Data Factory, Databricks, and Synapse Analytics",
      icon: "☁️",
    },
  ];
  ...
  const values = [
    {
      ...
      description: 'Building robust Azure data pipelines and ETL workflows',
      color: 'linear-gradient(135deg, #0078D4 0%, #002050 100%)'
    },
    {
      icon: '💻',
      title: 'Full Stack',
      description: 'MERN stack development for data-driven applications',
      color: 'linear-gradient(135deg, #002050 0%, #0078D4 100%)'
    },
    {
      icon: '📊',
      title: 'Analytics',
      description: 'Data analysis and visualization for insights',
      color: 'linear-gradient(135deg, #0078D4 0%, #002050 100%)'
    },
    {
      icon: '⚡',
      title: 'Performance',
      description: 'Optimizing data processing and application efficiency',
      color: 'linear-gradient(135deg, #002050 0%, #0078D4 100%)'
    }
  ]
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <div
                  className="absolute bottom-16 left-0 right-0 z-30 px-4 opacity-0 group-hover:opacity-100 
                ...
                {/* Video Controls */}
                <div
                  className="absolute bottom-4 left-0 right-0 z-30 px-4 opacity-0 group-hover:opacity-100 
          ...
          >
            ...
            <div className="relative ml-6 md:ml-8">
              {timeline.map((item, index) => (
                <motion.div
                  key={`${item.year}-${
                    timelineControls ? "visible" : "hidden"
                  }`}
